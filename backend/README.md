...
- MySQL 当前为 33 表 schema，新增 `semantic_chunk` 作为教材语义块，并包含一键生成 `generation_run` 与教案课次恢复 `lesson_plan_generation_item`；Zilliz 云端集合已切换为 `semantic_chunk_vector` 与 `knowledge_point_vector`
- 当前自动化测试基线：`261 passed`
