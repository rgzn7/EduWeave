...
class BusinessErrorCode(str, Enum):
    ...
    ASSESSMENT_SCENE_INVALID = "ASSESSMENT_SCENE_INVALID"
    PAPER_RESULT_NOT_FOUND = "PAPER_RESULT_NOT_FOUND"
    HOMEWORK_BLUEPRINT_NOT_FOUND = "HOMEWORK_BLUEPRINT_NOT_FOUND"
    HOMEWORK_RESULT_NOT_FOUND = "HOMEWORK_RESULT_NOT_FOUND"
    HOMEWORK_QUESTION_NOT_FOUND = "HOMEWORK_QUESTION_NOT_FOUND"
    COURSEWARE_RESULT_NOT_FOUND = "COURSEWARE_RESULT_NOT_FOUND"
    COVERAGE_REPORT_NOT_FOUND = "COVERAGE_REPORT_NOT_FOUND"
...
ERROR_CODE_HTTP_MAPPING: dict[BusinessErrorCode, int] = {
    ...
    BusinessErrorCode.ASSESSMENT_SCENE_INVALID: 422,
    BusinessErrorCode.PAPER_RESULT_NOT_FOUND: 404,
    BusinessErrorCode.HOMEWORK_BLUEPRINT_NOT_FOUND: 404,
    BusinessErrorCode.HOMEWORK_RESULT_NOT_FOUND: 404,
    BusinessErrorCode.HOMEWORK_QUESTION_NOT_FOUND: 404,
    BusinessErrorCode.COURSEWARE_RESULT_NOT_FOUND: 404,
    BusinessErrorCode.COVERAGE_REPORT_NOT_FOUND: 404,
    ...
    BusinessErrorCode.HOMEWORK_TASK_FAILED: 500,
    BusinessErrorCode.COURSEWARE_TASK_FAILED: 500,
    BusinessErrorCode.COVERAGE_TASK_FAILED: 500,
    BusinessErrorCode.TASK_STALE_ATTEMPT: 500,
    BusinessErrorCode.GENERATION_RUN_NOT_FOUND: 404,
    BusinessErrorCode.GENERATION_RUN_BLOCKED: 409,
}
