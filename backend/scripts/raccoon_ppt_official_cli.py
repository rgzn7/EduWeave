#!/usr/bin/env python3
# @Date: 2026-05-28
# @Author: xisy（仅添加本来源注释，下方为官方代码原样）
# @Discription: 官方 Raccoon PPT OpenAPI 测试脚本，原样取自 SenseTime-Copilot/raccoon-ppt-skill 仓库 scripts/main.py，
#               用于脱离项目封装、直接验证小浣熊 PPT 服务。用法见文件末尾子命令或 README。
