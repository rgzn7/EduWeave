<!-- @Date: 2026-05-31 @Author: xisy @Discription: EduWeave 项目中文说明文档 -->
...
- [贡献指南](CONTRIBUTING.md)：贡献流程、本地检查与敏感文件处理约束。

## 维护者

项目维护者信息见 [MAINTAINERS.md](MAINTAINERS.md)。其中 `rgzn7` 为 primary maintainer / project owner，`sevzq` 为 core maintainer，负责前后端功能维护、PR review、issue triage、release/readiness checks、AI workflow and automation maintenance 等协作维护事项。
